...
class TjDataRootClass : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		if let dataArray = dictionary["data"] as? [NSDictionary]{
			for dic in dataArray{
				let value = TjDataData(fromDictionary: dic)
				data.append(value)
			}
		}
    ...
    */
	...
	{
        data = aDecoder.decodeObject(forKey: "data") as? [TjDataData]
